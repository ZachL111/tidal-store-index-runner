...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tidal-store-index-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tidal-store-index-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tidal-store-index-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-tidal_store_index_runner-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
